...
export default function ClientProfile() {
  ...
  const [formData, setFormData] = useState({
    ...
    workingType: (user as any)?.workingType || '',
        ...
        <CardContent className="pt-6">
          <div className="flex flex-col md:flex-row items-center md:items-start space-y-4 md:space-y-0 md:space-x-6">
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <p className="text-blue-700 font-medium">{formData.designation} {formData.company && `at ${formData.company}`}</p>
              <p className="text-blue-600 text-sm">{formData.email}</p>
              <div className="mt-2 inline-block px-3 py-1 bg-blue-200 text-blue-900 rounded-full text-xs font-semibold">
                Client Account
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              {isEditing ? (
                ...
                <p className="text-lg font-semibold text-slate-900">{formData.company || 'Independent'}</p>
              )}
            </div>
            ...
            <div>
              ...
              {isEditing ? (
                ...
                <p className="text-lg font-semibold text-slate-900">{formData.designation}</p>
              )}
            </div>

            <div>
              <label className="block text-sm font-medium text-slate-700 mb-2">Working Type</label>
              {isEditing ? (
                <Input
                ...
                <p className="text-lg font-semibold text-slate-900 capitalize">{formData.workingType}</p>
              )}
            </div>
